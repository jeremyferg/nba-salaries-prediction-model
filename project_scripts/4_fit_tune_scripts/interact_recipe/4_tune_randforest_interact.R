...
#########################################################
#######                                          ########
######      TUNE RANDOM FOREST MODEL NONLINEAR    #######
#######                                          ########
#########################################################
#########################################################
...
rf_interact_params <- extract_parameter_set_dials(rf_spec) |> 
...
# build tuning grid
rf_grid <- grid_regular(rf_interact_params, levels = 5)
...
save(rf_interact_tuned, file = here('results/interact_recipe/rf_interact_tuned.rda'))
