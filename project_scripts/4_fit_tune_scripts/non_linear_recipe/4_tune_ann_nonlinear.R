...
############################################################
#######                                             ########
######      TUNE NEURAL NETWORKS MODEL NONLINEAR     #######
#######                                             ########
############################################################
############################################################
...
ann_nonlinear_params <- extract_parameter_set_dials(ann_spec) |> 
...
# build tuning grid
ann_grid <- grid_regular(ann_nonlinear_params, levels = 5)
...
save(ann_nonlinear_tuned, file = here('results/nonlinear_recipe/ann_nonlinear_tuned.rda'))
