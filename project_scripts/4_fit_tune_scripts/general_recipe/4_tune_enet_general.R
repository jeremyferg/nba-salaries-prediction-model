...
enet_general_params <- extract_parameter_set_dials(enet_spec) |> 
...
# build tuning grid
enet_grid <- grid_regular(enet_general_params, levels = 5)
...
save(enet_general_tuned, file = here('results/general_recipe/enet_general_tuned.rda'))
