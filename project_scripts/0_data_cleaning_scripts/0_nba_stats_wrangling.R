...
nba_stats <- read_csv(here('data/raw/nba_stats_raw.csv'))

# seasons when the player made the playoffs
made_playoffs <- read_csv(here('data/raw/player_made_playoffs.csv'))

# players that were playing in 1990
players_1990 <- read_csv(here('data/raw/1990_year_in_nba.csv'))
